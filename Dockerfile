...
RUN apt-get -y install --no-install-recommends g++ gcc make dos2unix python3 libncurses-dev bison flex libssl-dev libelf-dev wget curl libgmp-dev libmpfr-dev libmpc-dev git libncurses5-dev libreadline-dev autoconf automake texinfo libisl-dev  gcc-multilib g++-multilib xz-utils
